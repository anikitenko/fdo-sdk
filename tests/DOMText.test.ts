...
describe("DOMText", () => {
    ...
    it("should create a p", () => {
        ...
        expect(p).toBe(`<p id="hello" class="go11">Hello World</p>`);
    })

    it("should create a span", () => {
        const span = domText.createSpanText("Hello World", {}, "hello");
        expect(span).toBe(`<span id="hello" class="go11">Hello World</span>`);
    })

    it("should create a strong", () => {
        const strong = domText.createStrongText("Hello World", {}, "hello");
        expect(strong).toBe(`<strong id="hello" class="go11">Hello World</strong>`);
    })

    it("should create a text", () => {
        const text = domText.createText("Hello World", {}, "hello");
        expect(text).toBe(`<span id="hello" class="go11">Hello World</span>`);
    })
    ...
    it("should escape JSX-sensitive characters in text nodes", () => {
        ...
        expect(output).toBe(
            `<span id="safe-text" class="go11">"&lt;script&gt;alert(1)&lt;/script&gt;" &amp; &#123;value&#125;</span>`
        );
    });
