...
describe("DOMLink", () => {
    ...
    it("should create a link", () => {
        ...
        expect(link).toBe(`<a id="link" class="go11" href="https://google.com">test</a>`)
    });

    it("should create a link with a class", () => {
        domLink = new DOMLink("link", {classes: ["test-class"]});
        const link = domLink.createLink("test", "https://google.com");
        expect(link).toBe(`<a id="link" class="test-class go11" href="https://google.com">test</a>`)
    });

    it("should create a link with a class and an id and a target", () => {
        domLink = new DOMLink("link", {classes: ["test-class"]}, {target: "_blank"});
        const link = domLink.createLink("test", "https://google.com");
        expect(link).toBe(`<a id="link" class="test-class go11" href="https://google.com" target="_blank">test</a>`)
    });
    ...
    it("should create a link with a class and an id and a target and a rel", () => {
        ...
        const link = domLink.createLink("test", "https://google.com");
        expect(link).toBe(`<a id="link" class="test-class go11" href="https://google.com" target="_blank" rel="noopener">test</a>`)
    });
    ...
    it("should create a link with a class and an id and a target and a rel and a title", () => {
        ...
        const link = domLink.createLink("test", "https://google.com");
        expect(link).toBe(`<a id="link" class="test-class go11" href="https://google.com" target="_blank" rel="noopener" title="test-title">test</a>`)
    });
})